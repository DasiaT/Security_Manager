...
namespace Manager_Security_BackEnd.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        public RolesController(IRoles roles, General_Valid_Token general_Valid_Token)
        {
            _roles = roles;
        ...
        [HttpGet]
        public async Task<IActionResult> GetRoles([FromQuery] Comun_Filters value)
        {
            try
            {
                ...
                var result = await _roles.GetRolesAsync(value);
        ...
        [HttpPost]
        public async Task<IActionResult> PostRoles([FromBody] Roles_Request_Post value)
        {
            try
            {
                var authorizationHeader = HttpContext.Request.Headers.Authorization;
                ...
                var result = await _roles.PostRolesAsync(value);
        ...
        [HttpPatch]
        public async Task<IActionResult> PatchRoles([FromBody] Roles_Request_Patch value)
        {
            try
            {
                var authorizationHeader = HttpContext.Request.Headers.Authorization;
                ...
                var result = await _roles.PatchRolesAsync(value);
        ...
        [HttpDelete]
        public async Task<IActionResult> DeleteRoles([FromBody] Roles_Request_Delete value)
        {
            try
            {
                var authorizationHeader = HttpContext.Request.Headers.Authorization;
                ...
                var result = await _roles.DeleteRolesAsync(value);
