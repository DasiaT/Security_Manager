...
namespace Manager_Security_BackEnd.Controllers
{
    ...
    public class WorkstationController : Controller
    {
        ...
        public WorkstationController( IWorkstation workstation, General_Valid_Token general_Valid_Token)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> GetWorkstation([FromQuery] Comun_Filters value)
        {
            try
            {
                ...
                var result = await _workstation.GetWorkstationsAsync(value);
        ...
        [HttpPost]
        public async Task<IActionResult> PostWorkstation([FromBody] Information_Workstation_Request value)
        {
            try
            {
                var authorizationHeader = HttpContext.Request.Headers.Authorization;
                ...
                var result = await _workstation.PostWorkstationsAsync(value);
        ...
        [HttpPatch]
        public async Task<IActionResult> PatchWorkstation([FromBody] Information_Workstation_Model value)
        {
            try
            {
                var authorizationHeader = HttpContext.Request.Headers.Authorization;
                ...
                var result = await _workstation.PatchWorkstationsAsync(value);
        ...
        [HttpDelete]
        public async Task<IActionResult> DeleteWorkstation([FromBody] Information_Workstation_Request_Delete value)
        {
            try
            {
                var authorizationHeader = HttpContext.Request.Headers.Authorization;
                ...
                var result = await _workstation.DeleteWorkstationsAsync(value);
